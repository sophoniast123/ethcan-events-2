...
export default function Hero() {
  ...
  // Parallax: only the background layer animates on scroll.
  ...
  return (
    <section id="home" ref={sectionRef} className="relative flex min-h-screen flex-col overflow-hidden">
      ...
      {/* Content */}
      <div className="container-x relative z-10 flex flex-1 flex-col items-center justify-center pb-24 pt-36 text-center">
        <motion.span
        ...
        >
          ...
          culture — {EVENT.dateLabel}, at Science Museum, Addis Ababa, Ethiopia.
        </motion.p>

        {/* Schedule, Countdown & Location - Side by side on desktop */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.6, duration: 0.8 }}
          className="mt-10 w-full max-w-6xl flex flex-col lg:flex-row items-center justify-center gap-6"
        >
          {/* Event Schedule */}
          <div className="flex-1 lg:max-w-[380px] w-full">
            <div className="rounded-2xl border border-white/15 bg-white/5 p-4 sm:p-6 backdrop-blur-md">
          ...
          <div className="flex-shrink-0 w-full lg:w-auto">
            <div className="grid grid-cols-4 gap-3 sm:gap-5 justify-center">
          ...
          <div className="flex-shrink-0 w-full lg:w-auto">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-gold-500 to-terra-500 px-8 py-4 font-bold text-white shadow-lg shadow-terra-500/30 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-terra-500/40 active:translate-y-0 focus:outline-none focus:ring-2 focus:ring-gold-400 focus:ring-offset-2 focus:ring-offset-ink w-full lg:w-auto justify-center"
            >
